...
function Dashboard() {
	...
	return (
		<Container>
			...
			/>
			{isOpen ? (
				<TradeList title="" requestURL="/api/trades/current" />
			) : (
				<TradeList title="" requestURL="/api/trades/past" />
			)}
		</Container>
	);
}
