            ...
            <section className="row justify-content-center">   
                {registrationErrors.length > 0 
                    ...
                    <div className="alert alert-warning alert-dismissible fade show" role="alert">
                        ...
                        <button type="button" className="close" data-dismiss="alert" aria-label="Close" onClick={removingRegistrationErrors}>X</button>
                    </div>
                    </div> 
                : null}
                <section className="col-12 col-sm-6 col-md-4 form-section">
                    ...
                    <Formik
                        ...
                        <form className="form-container" onSubmit={handleSubmit}>
                            <FormGroup label='First Name' type='text' name='firstName' onChange={handleChange} onBlur={handleBlur} value={values.firstName}/>
                            {errors.firstName && touched.firstName}
                            <FormGroup label='Last Name' type='text' name='lastName' onChange={handleChange} onBlur={handleBlur} value={values.lastName}/>
                            ...
                            <FormGroup label='Confirm password' type='password' name='passwordConfirmation' onChange={handleChange} onBlur={handleBlur} value={values.passwordConfirmation}/>
